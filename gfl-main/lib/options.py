...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours.add_argument('--datasetDir', type=str, default="/mnt/data/Project/GFLNet-master/data/motion_datas")
        ...
        g_ours.add_argument('--save_root', type=str, default="/mnt/data/Project/GFLNet-master/gfl-main/result")
